...
def build_parser() -> argparse.ArgumentParser:
    ...
    project_init.add_argument("--pretty", action="store_true")
    ...
    part_parser.add_argument("--pretty", action="store_true")
    ...
    keyword_parser.add_argument("--pretty", action="store_true")
    ...
    bom_init.add_argument("--pretty", action="store_true")
    ...
    bom_add.add_argument("--pretty", action="store_true")
    ...
    bom_remove.add_argument("--pretty", action="store_true")
    ...
    bom_update.add_argument("--pretty", action="store_true")
    ...
    bom_export.add_argument("--pretty", action="store_true")
    ...
    bom_price.add_argument("--pretty", action="store_true")
    ...
    store_list.add_argument("--pretty", action="store_true")
    ...
    store_export.add_argument("--pretty", action="store_true")
    ...
    store_update.add_argument("--pretty", action="store_true")
